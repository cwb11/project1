...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOpen(false);
        gc.setServiceName("%sService");//举个例子，让它生成UserService，不会生成IUservice
       ...
       //打开这个运行时可重新覆盖
        ...
        if (scanner("是否继承基类").equalsIgnoreCase("y")){
            ...
            strategy.setSuperEntityClass("com.imooc.project.entity.BaseEntity");//表中有一些重复字段，继承父类可减少代码冗余
            // 写于父类中的公共字段
        ...
        strategy.setRestControllerStyle(false);//这边设置成false，不用每次刷新
        // 公共父类
        ...
        strategy.setLogicDeleteFieldName("deleted");//如果表中有这个字段，创建时会自动给你填充逻辑字段
        ArrayList<TableFill> tableFills = new ArrayList<>();//自动填充
